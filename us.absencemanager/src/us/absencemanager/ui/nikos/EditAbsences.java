...
public class EditAbsences extends JPanel{
	...
	public EditAbsences(){
      ...
      //Create the scroll pane and add the table to it.
        ...
        btPanel=new JPanel(new GridLayout(0,4));
        bCancel=new JButton("Cancel");
        bSave=new JButton("Save");
        bDelete=new JButton("Delete absences");
        bChTime=new JButton("Change time");
        btPanel.add(bCancel);
        btPanel.add(bDelete);
        btPanel.add(bChTime);
        btPanel.add(bSave);
        titleofPanel=new JLabel("Edit absences");
