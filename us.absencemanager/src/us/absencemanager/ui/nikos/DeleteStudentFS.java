...
public class DeleteStudentFS extends JPanel implements ActionListener{
	...
	DeleteStudentCont deleteStudentCont;
	DeleteStudentFS thisObject;
	
	public DeleteStudentFS(){
		super();
		...
		bNext.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				remove(mainPanel);
				mainPanel = new DeleteStudentCont();
				add(mainPanel,BorderLayout.CENTER);
				topFrame = (JFrame) SwingUtilities.getAncestorOfClass(JFrame.class, DeleteStudentFS.this);
				topFrame.pack();
			}
		});
