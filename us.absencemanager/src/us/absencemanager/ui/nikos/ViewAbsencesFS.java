...
public class ViewAbsencesFS extends JPanel implements ActionListener{
	...
	ViewAbsencesCont viewAbsencesCont;
	ViewAbsencesFS thisObject;
	
	public ViewAbsencesFS(){
		super();
		...
		bNext.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				remove(mainPanel);
				mainPanel = new ViewAbsencesCont();
				add(mainPanel,BorderLayout.CENTER);
				topFrame = (JFrame) SwingUtilities.getAncestorOfClass(JFrame.class, ViewAbsencesFS.this);
				topFrame.pack();
			}
		});
